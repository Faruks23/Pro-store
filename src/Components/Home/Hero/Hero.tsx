...
const Hero = () => {
  return (
    <div className='bg-gray-500 h-screen w-full pt-20'>
      <div className='container mx-auto'>
        <div className="top-hero flex justify-center items-center flex-col gap-4 text-center mt-[100px] max-w-[797px] mx-auto">
          <h1 className='font-bold text-5xl leading-[57px] text-white'>Crafting Comfort, Redefining Spaces. Your Home, Your Signature Style!</h1>
